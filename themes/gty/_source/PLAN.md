...
> **Superseded paths (2026-09-21):** folders are now `leadership-session` / `coaching-session`; participant URLs use `/gty/…`. See repo `AUTHORING.md`. This PLAN remains historical for Grupo B packaging decisions.
